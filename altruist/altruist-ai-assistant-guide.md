...
<!--
  ...
  Version: 1.1 | Last updated: 2026-07-22 | Language of user: unknown — detect it.
...
| Sensor not on the map after Step 4 | Wait a few minutes; verify coordinates are filled in «GPS & Sensors» and saved; verify the device has internet access. |
